...
def _cleanup_all_test_data() -> None:
...
@pytest.fixture
def clean_session_tables(async_engine_for_test: AsyncEngine) -> None:
    _cleanup_all_test_data()


@pytest.fixture
def clean_event_tables(async_engine_for_test: AsyncEngine) -> None:
    _cleanup_all_test_data()


@pytest.fixture
def clean_lead_tables(async_engine_for_test: AsyncEngine) -> None:
    _cleanup_all_test_data()


@pytest.fixture
def clean_silenced_tables(async_engine_for_test: AsyncEngine) -> None:
    _cleanup_all_test_data()
